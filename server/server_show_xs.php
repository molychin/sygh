<?php
	...
	if(!$query){
		...
		echo "					<textarea name='sszj_jy1' rows='9' cols='30' class='text_readonly' readonly>$sszj_jy1</textarea></td></tr>";
		...
		echo "					<textarea name='sszj_jy2' rows='9' cols='30' class='text_readonly' readonly>$sszj_jy2</textarea></td></tr>";
		...
		echo "					<textarea name='sszj_jy3' rows='9' cols='30' class='text_readonly' readonly>$sszj_jy3</textarea></td></tr>";
		...
		echo "					<textarea name='sszj_jy4' rows='9' cols='30' class='text_readonly' readonly>$sszj_jy4</textarea></td></tr>";	
		echo "				</table></td></tr>";
		echo "		</table></td></tr>";
		...
		echo "						<tr><td>班主任指导意见：<br><textarea name='pgtz_zdyj1' cols='100' rows='5' class='text_readonly' readonly>$pgtz_zdyj1</textarea></td></tr>";
		echo "					</table></td</tr>";
		...
		echo "						<tr><td>班主任指导意见：<br><textarea name='pgtz_zdyj2' cols='100' rows='5' class='text_readonly' readonly>$pgtz_zdyj2</textarea></td></tr>";
		echo "					</table></td</tr>";
		...
		echo "						<tr><td>班主任指导意见：<br><textarea name='pgtz_zdyj3' cols='100' rows='5' class='text_readonly' readonly>$pgtz_zdyj3</textarea></td></tr>";
		echo "					</table></td</tr>";
		...
		echo "						<tr><td>班主任指导意见：<br><textarea name='pgtz_zdyj4' cols='100' rows='5' class='text_readonly' readonly>$pgtz_zdyj4</textarea></td></tr>";
		echo "					</table></td</tr>";	
		echo "				</table></td></tr>";
		echo "</table>";
