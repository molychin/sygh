...
<?php
	...
	if(!$query){
		...
		echo "		<tr>";
		echo "			<td>自我描述<button type='button' id='but_zwms'>隐藏/显示</button>
							<table id='tab_zwms'>";
		...
		echo "		<tr>";
		echo "		<td>SWOT分析<button type='button' id='but_swot'>隐藏/显示</button>
						<table id='tab_swot'>";
		...
		echo "		<tr><td>如何解决劣势或不足<button type='button' id='but_jjls'>隐藏/显示</button><table id='tab_jjls'>";
		echo "			<tr><td>如<br>何<br>解<br>决<br>劣<br>势<br>或<br>不<br>足<br></td>";
		echo "				<td><textarea name='jjls' rows='9' cols='100'>$jjls</textarea></td></tr>";
		echo "		</table></td></tr>";		
		
	
		echo "		<tr><td>想从事的职业<button type='button' id='but_cszy'>隐藏/显示</button><table id='tab_cszy'>";
		...
		echo "		<tr><td>职业生涯发展规划<button type='button' id='but_sygh'>隐藏/显示</button><table id='tab_sygh'>";
