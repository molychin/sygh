...
<?php
	...
	if(!$query){
		...
		echo "			</table></td></tr>";
		echo "			<tr><td><table><tr align='left'><td>职业四：<br><input type='text' value='$zhiye4' name='zhiye4' size='50' /></td></tr>";
		echo "				<tr align='left'><td>职业发展路线：<br><input type='text' value='$fzlx4' name='fzlx4' size='50' /></td></tr>";
		echo "				<tr align='left'><td>对人才的素质要求及所需专业的技能水平:<br>";
		echo "					<textarea name='jnsp4' rows='9' cols='100'>$jnsp4</textarea></td></tr>";
		echo "			</table></td></tr>";
		echo "		</table></td></tr>";		
