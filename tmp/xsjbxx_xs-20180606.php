...
<?php
	...
	if(!$query){
		...
		echo "					<tr><td>第<br>二<br>学<br>年<br>末</td><td><textarea name='sszj_zp2' rows='9' cols='70' readonly class='text_readonly'>$sszj_zp2</textarea></td><td>";
		echo "					<textarea name='js_xuenian2' rows='9' cols='30' readonly class='jsjy_textarea'></textarea></td></tr>";
		echo "					<tr><td>第<br>三<br>学<br>年<br>末</td><td><textarea name='sszj_zp3' rows='9' cols='70' readonly class='text_readonly'>$sszj_zp3</textarea></td><td>";
		echo "					<textarea name='js_xuenian3' rows='9' cols='30' readonly class='jsjy_textarea'></textarea></td></tr>";
		echo "					<tr><td>第<br>四<br>学<br>年<br>末</td><td><textarea name='sszj_zp4' rows='9' cols='70' readonly class='text_readonly'>$sszj_zp4</textarea></td><td>";
