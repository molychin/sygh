...
<script type="text/javascript">
	alert('填表说明：\n1.由于填写内容较多，建议学生先在WORD中完成《生涯规划》的内容，再将其内容复制到此处；\n2.建议每填写完成一个栏目的内容，就先点击保存，避免提交失败造成数据丢失；\n3.如需在同一台电脑上连续完成不同学生的填表，请务必先点击注销退出后，再进行另一个学生的登录填写，否则有可能会造成数据丢失。');
	//window.location.href="xsjbxx_js.php";		
</script>

<br>
<b class='red'>常熟理工学院-大学生职业生涯规划书</b><br><br>
<form id="id_frm_zysy" name="form_xsjbxx" action="save_xsjbxx.php" method="post">

<?php
	if(substr($dqxn,0,4)-$nianji==0){
		$dqxn="";
	}else{
		$dqxn="readonly";
	}
	...
	if(!$query){
		...
		echo "					<td>家庭电话：</td><td><input type='text' value='$jtdh' name='jiatingdianhua' class='text_readonly' /></td></tr>";
		echo "					<tr><td>邮政编码：</td><td colspan='5'><input type='text' value='$yzbm' name='youzhengbianma' class='text_readonly' /></td></tr>";
		echo "			</table></td>";
		...
		echo "				<td><table><tr align='left'><td>职业一：<br><input type='text' value='$zhiye1' name='zhiye1' size='50' /></td></tr>";
		echo "					<tr align='left'><td>职业发展路线：<br><input type='text' value='$fzlx1' name='fzlx1' size='50' /></td></tr>";
		echo "					<tr align='left'><td>对人才的素质要求及所需专业的技能水平:<br>";
		echo "						<textarea name='jnsp1' rows='9' cols='100'>$jnsp1</textarea></td></tr>";
		echo "				</table></td></tr>";
		echo "			<tr><td><table><tr align='left'><td>职业二：<br><input type='text' value='$zhiye2' name='zhiye2' size='50' /></td></tr>";
		echo "				<tr align='left'><td>职业发展路线：<br><input type='text' value='$fzlx2' name='fzlx2' size='50' /></td></tr>";
		echo "				<tr align='left'><td>对人才的素质要求及所需专业的技能水平:<br>";
		echo "					<textarea name='jnsp2' rows='9' cols='100'>$jnsp2</textarea></td></tr>";
		echo "			</table></td></tr>";
		echo "			<tr><td><table><tr align='left'><td>职业三：<br><input type='text' value='$zhiye3' name='zhiye3' size='50' /></td></tr>";
		echo "				<tr align='left'><td>职业发展路线：<br><input type='text' value='$fzlx3' name='fzlx3' size='50' /></td></tr>";
		echo "				<tr align='left'><td>对人才的素质要求及所需专业的技能水平:<br>";
		echo "					<textarea name='jnsp3' rows='9' cols='100'>$jnsp3</textarea></td></tr>";
		echo "			</table></td></tr>";
		...
		echo "				<table>";
		echo "					<tr><td>第<br>一<br>学<br>年</td><td><textarea name='mbcs_n1' rows='9' cols='100'>$mbcs_n1</textarea></td</tr>";
		echo "					<tr><td>第<br>二<br>学<br>年</td><td><textarea name='mbcs_n2' rows='9' cols='100'>$mbcs_n2</textarea></td</tr>";
		echo "					<tr><td>第<br>三<br>学<br>年</td><td><textarea name='mbcs_n3' rows='9' cols='100'>$mbcs_n3</textarea></td</tr>";
		echo "					<tr><td>第<br>四<br>学<br>年</td><td><textarea name='mbcs_n4' rows='9' cols='100'>$mbcs_n4</textarea></td</tr>";	
		echo "				</table></td></tr>";
		echo "			<tr><td></td><td>";
		echo "				<table>";
		echo "					<tr><td>五<br>年<br>内</td><td><textarea name='mbcs_n5' rows='9' cols='100'>$mbcs_n5</textarea></td</tr>";
		echo "					<tr><td>十<br>年<br>内</td><td><textarea name='mbcs_n10' rows='9' cols='100'>$mbcs_n10</textarea></td</tr>";
		echo "				</table></td></tr>";
		echo "		</table></td></tr>";
		...
		echo "					<tr><td>第<br>一<br>学<br>年<br>末</td><td><textarea name='sszj_zp1' rows='9' cols='70'>$sszj_zp1</textarea></td><td>";
		echo "					<textarea name='js_xuenian1' rows='9' cols='30' readonly class='jsjy_textarea'>$sszj_jy1</textarea></td></tr>";
		
		echo "					<tr><td>第<br>二<br>学<br>年<br>末</td><td><textarea name='sszj_zp2' rows='9' cols='70'>$sszj_zp2</textarea></td><td>";
		echo "					<textarea name='js_xuenian2' rows='9' cols='30' readonly class='jsjy_textarea'>$sszj_jy2</textarea></td></tr>";
		
		echo "					<tr><td>第<br>三<br>学<br>年<br>末</td><td><textarea name='sszj_zp3' rows='9' cols='70'>$sszj_zp3</textarea></td><td>";
		echo "					<textarea name='js_xuenian3' rows='9' cols='30' readonly class='jsjy_textarea'>$sszj_jy3</textarea></td></tr>";
		
		echo "					<tr><td>第<br>四<br>学<br>年<br>末</td><td><textarea name='sszj_zp4' rows='9' cols='70'>$sszj_zp4</textarea></td><td>";
		echo "					<textarea name='js_xuenian4' rows='9' cols='30' readonly class='jsjy_textarea'>$sszj_jy4</textarea></td></tr>";	
		echo "				</table></td></tr>";
		echo "		</table></td></tr>";
		...
		echo "						<tr><td>目标实现情况：<br><textarea name='pgtz_sxqk1' cols='100' rows='5'>$pgtz_sxqk1</textarea></td></tr>";
		echo "						<tr><td>调整情况：<br><textarea name='pgtz_tzqk1' cols='100' rows='5'>$pgtz_tzqk1</textarea></td></tr>";
		echo "						<tr><td>班主任指导意见：<br><textarea name='pgtz_zdyj1' cols='100' rows='5' readonly class='jsjy_textarea'>$pgtz_zdyj1</textarea></td></tr>";
		echo "					</table></td</tr>";
		echo "					<tr><td>第<br>二<br>学<br>年</td><td><table>";
		echo "						<tr><td>目标实现情况：<br><textarea name='pgtz_sxqk2' cols='100' rows='5' readonly class='text_readonly'>$pgtz_sxqk2</textarea></td></tr>";
		echo "						<tr><td>调整情况：<br><textarea name='pgtz_tzqk2' cols='100' rows='5' readonly class='text_readonly'>$pgtz_tzqk2</textarea></td></tr>";
		echo "						<tr><td>班主任指导意见：<br><textarea name='pgtz_zdyj2' cols='100' rows='5' readonly class='jsjy_textarea'>$pgtz_zdyj2</textarea></td></tr>";
		echo "					</table></td</tr>";
		echo "					<tr><td>第<br>三<br>学<br>年</td><td><table>";
		echo "						<tr><td>目标实现情况：<br><textarea name='pgtz_sxqk3' cols='100' rows='5' readonly class='text_readonly'>$pgtz_sxqk3</textarea></td></tr>";
		echo "						<tr><td>调整情况：<br><textarea name='pgtz_tzqk3' cols='100' rows='5' readonly class='text_readonly'>$pgtz_tzqk3</textarea></td></tr>";
		echo "						<tr><td>班主任指导意见：<br><textarea name='pgtz_zdyj3' cols='100' rows='5' readonly class='jsjy_textarea'>$pgtz_zdyj3</textarea></td></tr>";
		echo "					</table></td</tr>";
		echo "					<tr><td>第<br>四<br>学<br>年</td><td><table>";
		echo "						<tr><td>目标实现情况：<br><textarea name='pgtz_sxqk4' cols='100' rows='5' readonly class='text_readonly'>$pgtz_sxqk4</textarea></td></tr>";
		echo "						<tr><td>调整情况：<br><textarea name='pgtz_tzqk4' cols='100' rows='5' readonly class='text_readonly'>$pgtz_tzqk4</textarea></td></tr>";
		echo "						<tr><td>班主任指导意见：<br><textarea name='pgtz_zdyj4' cols='100' rows='5' readonly class='jsjy_textarea'>$pgtz_zdyj4</textarea></td></tr>";
		echo "					</table></td</tr>";	
		echo "				</table></td></tr>";
		echo "</table>";
