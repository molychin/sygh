...
<?php
	...
	if(!$query){
		...
		echo "						<tr><td>目标实现情况：<br><textarea name='pgtz_sxqk2' cols='100' rows='5'>$pgtz_sxqk2</textarea></td></tr>";
		echo "						<tr><td>调整情况：<br><textarea name='pgtz_tzqk2' cols='100' rows='5'>$pgtz_tzqk2</textarea></td></tr>";
		...
		echo "						<tr><td>目标实现情况：<br><textarea name='pgtz_sxqk3' cols='100' rows='5' >$pgtz_sxqk3</textarea></td></tr>";
		echo "						<tr><td>调整情况：<br><textarea name='pgtz_tzqk3' cols='100' rows='5' >$pgtz_tzqk3</textarea></td></tr>";
		...
		echo "						<tr><td>目标实现情况：<br><textarea name='pgtz_sxqk4' cols='100' rows='5' >$pgtz_sxqk4</textarea></td></tr>";
		echo "						<tr><td>调整情况：<br><textarea name='pgtz_tzqk4' cols='100' rows='5' >$pgtz_tzqk4</textarea></td></tr>";
