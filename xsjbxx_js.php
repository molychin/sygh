...
<?php
	...
	echo "<tr><td><b>学号|姓名</b></td><td><b>学号|姓名</b></td><td><b>学号|姓名</b></td></tr>";
	$count=0;
	...
	while($row=mysqli_fetch_array($query,MYSQLI_ASSOC)){
		$rowcount=0;
		$bjmc=$row['bjmc'];
		$SQL1="select concat(xs.xh,'|',xs.xm) xhxm,xs.xh,xs.xzb,sy.jspybj,sy.txsj,xs.nj from xsjbxxb xs,sygh_zysyghs sy where xzb='$bjmc' and xs.xh=sy.xh";
		//echo $SQL1.'<br>';
		$query1=mysqli_query($conn,$SQL1)or die("Error querying database1,not found,xsjbxx_js2.php.");
		echo "<tr><td colspan=3><b>$bjmc</b></td></tr><tr>";
		...
		echo "<td><input type='button' id='id_$xh' onClick=xhxmClicked('$xh','$nj',$count) value='$xhxm' class='$buttonType'></input></td>";
		if($rowcount%3==0){
			echo "</tr><tr>";
		}
	}		
